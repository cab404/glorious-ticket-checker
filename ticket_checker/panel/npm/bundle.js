(function () {
    ...
    function start_qr(elem) {
        var prev_code = "";
        var scanner = new QrScanner(elem, function (decoded) {
    ...
    function new_code(code) {
        document.getElementById("title").innerHTML = code;
        fetch("/check_ticket/" + code).then(function (resp) {
        });
    }
    start_qr(document.getElementById("scanner"));
